...
def test_apikey_header_auth_failure(apikey_header_client, mock_request: requests_mock.Mocker) -> None:
...
def test_apikey_param_auth_failure(apikey_param_client, mock_request: requests_mock.Mocker) -> None:
