...
class TestMethodCall:
    ...
    def test_init_with_exception(self):
        ...
        # Act
        call = MethodCall(method_name="test_method", args=(1, 2), kwargs={"a": "b"}, exception=exception)
    ...
    def test_repr_with_exception(self):
        ...
        # Arrange
        exception = ValueError("Test error")
        call = MethodCall(method_name="test_method", args=(1, "string"), kwargs={"a": "b"}, exception=exception)
