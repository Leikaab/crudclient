...
class TestHttpClientServerErrors:
    ...
    def test_500_error(self, http_client: Client, mock_request: requests_mock.Mocker) -> None:
        """
    ...
    def test_502_error(self, http_client: Client, mock_request: requests_mock.Mocker) -> None:
        """
    ...
    def test_503_error(self, http_client: Client, mock_request: requests_mock.Mocker) -> None:
        """
    ...
    def test_504_error(self, http_client: Client, mock_request: requests_mock.Mocker) -> None:
        """
