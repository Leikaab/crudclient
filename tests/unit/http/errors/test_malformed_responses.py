...
class TestHttpClientMalformedResponses:
    ...
    def test_malformed_json_response(self, http_client: Client, mock_request: requests_mock.Mocker) -> None:
        """
    ...
    def test_empty_response(self, http_client: Client, mock_request: requests_mock.Mocker) -> None:
        """
    ...
    def test_non_json_content_type(self, http_client: Client, mock_request: requests_mock.Mocker) -> None:
        """
    ...
    def test_unexpected_content_type(self, http_client: Client, mock_request: requests_mock.Mocker) -> None:
        """
