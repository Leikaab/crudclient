...
The DevContainer setup is now tested using a github actions workflow on latest macos, ubuntu and windows. Currently we are having problems TESTING on macos/window, but it runs fine.
