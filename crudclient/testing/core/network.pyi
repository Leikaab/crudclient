...
in tests, such as latency, packet loss, and errors. These simulations
help test the robustness of code that makes network requests.
"""
...
class NetworkCondition:
    ...
    This class allows tests to simulate realistic network conditions like latency,
    packet loss, and errors. It can be used with mock HTTP clients to test how
    code handles different network scenarios without requiring actual network
    infrastructure.
