...
class OAuthGrantHandler:
    def __init__(
        ...
        self.supported_grant_types: Set[str] = {
    ...
    def handle_token_request(
        ...
        if grant_type == "authorization_code":
            ...
            return self._handle_password_grant(
            ...
            return {
                ...
                "error_description": "Grant type not properly implemented"
            }
    ...
    def _handle_authorization_code_grant(
        ...
        if code_data["redirect_uri"] != redirect_uri:
            return {
                "error": "invalid_grant",
                "error_description": "Redirect URI does not match the one used in the authorization request"
            }

        # Create a new token
        return self.token_manager.create_token(
            client_id=client_id,
            scope=scope or code_data["scope"],
