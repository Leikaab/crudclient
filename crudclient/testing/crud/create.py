...
class CreateMock(BaseCrudMock):
    ...
    def with_unique_constraint(
        ...
        self.post = post_with_unique_constraint
    ...
    def with_validation_constraint(
        ...
        # Replace the post method with our wrapper
        self.post = post_with_validation_constraint
    ...
    def with_auto_increment_id(self, id_field: str = "id") -> 'CreateMock':
        ...
        def post_with_auto_increment(url: str, **kwargs: Any) -> Any:
            ...
            if pattern:
                ...
                if isinstance(response_obj, MockResponse) and hasattr(response_obj, '_json_data'):
        ...
        # Replace the post method with our wrapper
        self.post = post_with_auto_increment
